...
public class RemindersAdapter {
    ...
    public RemindersAdapter(Context ctx)
    {
        this.mCtx = ctx;
    }
    ...
    public void createReinder(String name, boolean important)
    {
    ...
    public Reminder fetchReminderById(int id)
    {
        Cursor cursor = mDb.query(TABLE_NAME, new String[]
                {COL_ID, COL_CONTENT, COL_IMPORTANT}, COL_ID + "=?", new String[]
        ...
        return new Reminder( cursor.getInt(INDEX_ID),
                cursor.getString(INDEX_CONTENT), cursor.getInt(INDEX_IMPORTANT)); }
